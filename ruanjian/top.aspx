          ...
          <td>
            <div class ="menu">
              <table width="100%" height="23" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="14%">&nbsp;</td>
                  <td style="width: 33%">Current user：<%=Session["username"].ToString().Trim() %></td>
                  <td style="width: 35%">authority：<%=Session["cx"].ToString().Trim() %></td>
                  <td width="25%"><a href="logout.aspx" target=_top><font color=white>Sign out</font></a></td>
                </tr>
              </table>
            </div>
          </td>
...
<table width="100%" height="25" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td background="images/menu_bg.jpg" width="165">
      <div class ="menu_left">
        <p>Current user：<%=Session["username"].ToString().Trim() %></p>
      </div>
    </td>
