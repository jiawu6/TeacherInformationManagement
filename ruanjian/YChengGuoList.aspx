<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="YChengGuoList.aspx.cs" Inherits="YChengGuoList" %>
    ...
    <table   border="1" bordercolordark="#9cc7ef" bordercolorlight="#145aa0"
            ...
            <tr>
             ...
             <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:HyperLinkField DataNavigateUrlFields="ID" DataNavigateUrlFormatString="ChengGuoDetial.aspx?ID={0}"
