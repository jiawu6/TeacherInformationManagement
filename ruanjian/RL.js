//  The main calling functions are setday (this, [object]) and setday (this), [object] is the name of the control output from the control.
...
window.frames.endDateLayer.document.close();        //Solve the problem of IE progress bar not ending


//==================================================== WEB Page Display Part ======================================================
var outObject;
var outButton;        //Click on the button

var outDate="";        //Date of the object to be stored
var bUseTime=false;        //Whether to use time or not
var odatelayer=window.frames.endDateLayer.document.all;        //Store calendar objects
...
function setday(tt,obj) //calling function
{
    ...
    var ttyp = tt.type;    //Types of TT controls

    while (tt = tt.offsetParent){ttop+=tt.offsetTop; tleft+=tt.offsetLeft;}
    dads.top = (ttyp=="image") ? ttop+thei : ttop+thei+6;
    dads.left = tleft;
    outObject = (arguments.length == 1) ? th : obj;
    outButton = (arguments.length == 1) ? null : th;    //Set the button clicked externally

    //Display the calendar year and month based on the date of the current input box
    var reg = /^(\d+)-(\d{1,2})-(\d{1,2})/;        //Time free
    ...
    //Non-strict validation to determine whether time is used in initialization
...
var MonHead = new Array(12);    //Define the maximum number of days per month in the solar calendar

MonHead[0] = 31; MonHead[1] = 28; MonHead[2] = 31; MonHead[3] = 30; MonHead[4]  = 31; MonHead[5]  = 30;
MonHead[6] = 31; MonHead[7] = 31; MonHead[8] = 30; MonHead[9] = 31; MonHead[10] = 30; MonHead[11] = 31;

var meizzTheYear=new Date().getFullYear(); //Initial values of variables for a defined year

var meizzTheMonth=new Date().getMonth()+1; //Initial value of variable defining month

var meizzTheDate=new Date().getDate();    //Initial value of variable defining date
var meizzTheHour=new Date().getHours();    //Define the initial value of an hour variable

var meizzTheMinute=new Date().getMinutes();//Define the initial value of the minute variable
var meizzTheSecond=new Date().getSeconds();//Define the initial value of the second variable

var meizzWDay=new Array(37);    //Array defining write date

function document.onclick() //Close the control at any Click 
{ 
    with(window.event)
    {
...
function document.onkeyup()        //Press Esc key to close and switch focus to close
{
...
function tmpSelectYearInnerHTML(strYear) //Year drop-down box
{
...
function tmpSelectMonthInnerHTML(strMonth) //Month drop-down box
{
